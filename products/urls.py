...
from products.views import ProductListView, ProductUserView, ProductDetailView, ProductCreateView, ProductDeleteView, ProductAddFavoriteView, FavoriteProductListView
...
urlpatterns = [
    ...
    path('products/<str:username>/<int:pk>/favorite/', ProductAddFavoriteView.as_view(), name='product-favorite'),
